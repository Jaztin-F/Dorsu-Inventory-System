...
public class Director extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        form.setMinimumSize(new java.awt.Dimension(558, 339));
        form.setPreferredSize(new java.awt.Dimension(558, 339));
        form.setResizable(false);
        form.setSize(new java.awt.Dimension(558, 339));
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Director", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bell MT", 0, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        panel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 90, -1));

        jLabel3.setFont(new java.awt.Font("Bell MT", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Birth Date");
        panel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 150, 30));

        jLabel4.setFont(new java.awt.Font("Bell MT", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Movie");
        panel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 160, 30));

        movie.setFont(new java.awt.Font("Century", 0, 14)); // NOI18N
        panel.add(movie, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 170, 266, 32));

        birth.setFont(new java.awt.Font("Century", 0, 14)); // NOI18N
        panel.add(birth, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, 266, 32));

        name.setFont(new java.awt.Font("Century", 0, 14)); // NOI18N
        panel.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 266, 32));
        ...
        panel.add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, 110, 50));
        ...
        panel.add(Update, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 230, 110, 50));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 20, 180, 70));
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
          // Add Movie Function
           DefaultTableModel tblModel = (DefaultTableModel)jTable1.getModel();
            ...
            if(name.getText().equals("")||birth.getText().equals("")||movie.getText().equals("")){  
           //if any of the following field leave blank then show message
            ...
            String data[]={name.getText(),birth.getText(),movie.getText()};
